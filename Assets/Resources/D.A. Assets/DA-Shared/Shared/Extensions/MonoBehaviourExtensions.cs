...
namespace DA_Assets.Shared.Extensions
{
    public static class MonoBehExtensions
    {
        ...
        public static GameObject RemoveRectTransform(this GameObject gameObject)
        {
            ...
            foreach (Component component in components)
            {
                if (!(component is Transform))
                {
                    ...
                    CopySerializedFields(component, newComponent);
                }
            }
        ...
        public static void CopySerializedFields(Component source, Component destination)
        {
        ...
        public static bool SaveAsPrefabAsset<T>(this GameObject go, string localPath, out T savedPrefab, out Exception ex) where T : MonoBehaviour
        {
            ...
            try
            {
                prefabGo = UnityEditor.PrefabUtility.SaveAsPrefabAsset(go, localPath, out bool success);
            }
            catch (Exception ex1)
            {
                ex = ex1;
