...
namespace DA_Assets.FCU
{
    ...
    public static class FcuLocExtensions
    {
        public static string Localize(this FcuLocKey key, params object[] args) =>
            FcuLocalizator.Instance.Localize(key.ToString(), DA_Assets.Shared.DALanguage.en, args);
    }
    ...
    public enum FcuLocKey
    {
        ...
        tooltip_override_letter_spacing,
        label_override_line_spacing,
        tooltip_override_line_spacing,
        label_adapt_outlines,
        tooltip_adapt_outlines,
        label_use_unity_image_when_square_corners,
        tooltip_use_unity_image_when_square_corners,
        label_use_unity_image_if_can,
        tooltip_use_unity_image_if_can,
