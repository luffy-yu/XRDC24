...
namespace DA_Assets.FCU
{
    ...
    public class FcuEventHandlers : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public void UpdatePrefabs_OnClick()
        {
            monoBeh.PrefabUpdater.UpdatePrefabs().StartDARoutine(monoBeh);
        }
        ...
        public static void DestroyChilds_OnClick(GameObject parent)
        {
            AssetTools.DestroyChilds(parent).StartDARoutine(null);
        }
