...
namespace DA_Assets.FCU
{
    ...
    public class FcuConfig : SingletoneScriptableObject<FcuConfig>
    {
        ...
        [SerializeField] string recentProjectsPrefsKey = nameof(recentProjectsLimit);
        public string RecentProjectsPrefsKey => recentProjectsPrefsKey;
        ...
        public const char AsterisksChar = '•';
    ...
    [Serializable]//need add set dirty for fcuconfig
    public class DebugSettings
    {
        [SerializeField] bool logDefault = true;
        public bool LogDefault { get => logDefault; set => logDefault = value; }
        [SerializeField] bool logSetTag = true;
        public bool LogSetTag { get => logSetTag; set => logSetTag = value; }
        [SerializeField] bool logIsDownloadable = true;
        public bool LogIsDownloadable { get => logIsDownloadable; set => logIsDownloadable = value; }
        [SerializeField] bool logTransform = true;
        public bool LogTransform { get => logTransform; set => logTransform = value; }
        [SerializeField] bool logGameObjectDrawer = true;
        public bool LogGameObjectDrawer { get => logGameObjectDrawer; set => logGameObjectDrawer = value; }
        [SerializeField] bool logComponentDrawer = true;
        public bool LogComponentDrawer { get => logComponentDrawer; set => logComponentDrawer = value; }
        [SerializeField] bool logHashGenerator = true;
        public bool LogHashGenerator { get => logHashGenerator; set => logHashGenerator = value; }
