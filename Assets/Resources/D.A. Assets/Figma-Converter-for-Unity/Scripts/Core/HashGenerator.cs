...
namespace DA_Assets.FCU
{
    ...
    public class HashGenerator : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        private void GetHashRecursive(FObject fobject, List<FObjectHashData> values, int indent)
        {
            ...
            FcuLogger.Debug($"IsInsideDownloadable | {fobject.Data.NameHierarchy} | {downloadableFObject.Name}", FcuLogType.HashGenerator);
            ...
            fobjectHash.FieldHashes.Add(new FieldHashData("GetFigmaRotationAngle", fobject.GetFigmaRotationAngle()));
            ...
            /*  }
              ...
              {
                  FcuLogger.Debug(ex, FcuLogType.Error);
              }*/
