...
namespace DA_Assets.FCU.Model
{
    ...
    {
        [SerializeField] UseUnityImageWhen useUnityImageWhen = UseUnityImageWhen.Sprite | UseUnityImageWhen.RectangleNoRoundedCorners;
        [SerializeProperty(nameof(useUnityImageWhen))]
        public UseUnityImageWhen UseUnityImageWhen
        {
            get
            {
                return useUnityImageWhen;
            }
            set
            {
                SetValue(ref useUnityImageWhen, value);
            }
        }
