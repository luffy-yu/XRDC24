...
namespace DA_Assets.FCU.Model
{
    ...
    public class SyncData : IHaveId
    {
        ...
        [SerializeField] GameObject rectGameObject;
...
#endif
        [SerializeField] FGraphic graphic;


        internal FGraphic Graphic { get => graphic; set => graphic = value; }

        public string UitkType { get; set; }
        public string HashData { get; set; }
        private string hashDataTree;
