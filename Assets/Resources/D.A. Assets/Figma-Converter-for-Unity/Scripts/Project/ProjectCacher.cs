...
namespace DA_Assets.FCU
{
    ...
    public class ProjectCacher : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        {
#if UNITY_EDITOR
            string savedData = UnityEditor.EditorPrefs.GetString(FcuConfig.Instance.RecentProjectsPrefsKey, "");
...
#if UNITY_EDITOR
            UnityEditor.EditorPrefs.SetString(FcuConfig.Instance.RecentProjectsPrefsKey, json);
#endif
        }
    }
