...
namespace DA_Assets.FCU
{
    ...
    public sealed class FigmaConverterUnity : MonoBehaviour
    {
        ...
        public NovaDrawer NovaDrawer => novaDrawer.SetMonoBehaviour(this);
#endif

#if FCU_UITK_EXT_EXISTS
        [SerializeField] UitkConverter uitkConverter;
        [SerializeProperty(nameof(uitkConverter))]
        public UitkConverter UITK_Converter => uitkConverter.SetMonoBehaviour(this);
#endif
        ...
        public ScriptGenerator ScriptGenerator => scriptGenerator.SetMonoBehaviour(this);
        ...
        public PrefabUpdater PrefabUpdater => prefabUpdater.SetMonoBehaviour(this);

        [SerializeField] FolderCreator folderCreator;
        [SerializeProperty(nameof(folderCreator))]
        public FolderCreator FolderCreator => folderCreator.SetMonoBehaviour(this);
        ...
        public GraphicHelpers GraphicHelpers => graphicHelpers.SetMonoBehaviour(this);
        ...
        public NameSetter NameSetter => nameSetter.SetMonoBehaviour(this);
