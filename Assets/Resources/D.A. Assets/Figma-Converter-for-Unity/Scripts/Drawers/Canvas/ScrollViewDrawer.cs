...
{
    [Serializable]
    public class ScrollViewDrawer : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        {
            yield return SetTargetGraphicsScrollViews();
            scrollViews.Clear();
        }

        private IEnumerator SetTargetGraphicsScrollViews()
        {
